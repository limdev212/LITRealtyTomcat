                                ...
                                <div class="col-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <select class="form-control" id="catagories">
                                            <option>Less than &euro; 100,000</option>
                                            <option>&euro; 100,000 - 150,000</option>
                                            <option>&euro; 150,000 - 200,000</option>
                                            <option>&euro; 200,000 - 250,000</option>
                                            <option>&euro; 250,000 - 300,000</option>
                                            <option>&euro; 300,000 - 350,000</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 col-lg-4">
