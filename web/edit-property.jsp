...
<head>
    ...
    <!-- Title  -->
    <title>Edit Property | LIT Realty </title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Your Listings</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form action="SaveEditServlet" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-12 col-md-12 col-lg-12">
                                    Garage Type
                                <c:choose>
                                    <c:when test="${garagetype.garageId=='1'}">
                                        <select class="form-control" name="garagetype">
                                            <option selected="selected" value="1">Attached</option>
                                            <option value="2">Detached</option>
                                            <option value="3">Car Port</option>
                                            <option value="4">None</option>
                                        </select>
                                    </c:when>
                                        <c:when test="${garagetype.garageId=='2'}">
                                        <select class="form-control" name="garagetype">
                                        ...
                                        <c:when test="${garagetype.garageId=='3'}">
                                        <select class="form-control" name="garagetype">
                                            <option value="1">Attached</option>
                                            <option value="2">Detached</option>
                                            <option selected="selected" value="3">Car Port</option>
                                            <option value="4">None</option>
                                        </select>
                                    </c:when>
                                    <c:otherwise>
                                        <select class="form-control" name="garagetype">
                                            ...
                                            <option value="2">Detached</option>
                                            <option value="3">Car Port</option>
                                            <option selected="selected" value="4">None</option>
                                        </select>
                                    </c:otherwise>
                                </c:choose>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-12 col-md-12 col-lg-12">
                                    ...
                                    <select class="form-control" name="styletype">
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='2'}">
                                                <option selected="selected" value="2">Semi Detached</option>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='3'}">
                                                <option selected="selected" value="3">Detached</option>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='4'}">
                                                <option selected="selected" value="4">Cottage</option>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='5'}">
                                                <option selected="selected" value="5">Terrace</option>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='8'}">
                                                <option selected="selected" value="8">Duplex</option>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='9'}">
                                                <option selected="selected" value="9">Condo</option>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='10'}">
                                                <option selected="selected" value="10">Apartment</option>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${style.styleId=='11'}">
                                                <option selected="selected" value="11">Other</option>
                                            </c:when>
                                            <c:otherwise>
